...
const translations = {
  vi: {
    ...
    noCodeExplanation: "Chưa có phần giải thích cho đoạn code này.",
    closeExplainCode: "Đóng giải thích",
    showMoreCode: "Xem thêm",
    showLessCode: "Thu gọn",
    expandCode: "Mở toàn màn hình",
    closeExpandedCode: "Đóng toàn màn hình",
  ...
  en: {
    ...
    noCodeExplanation: "No explanation has been added for this code yet.",
    closeExplainCode: "Close explanation",
    showMoreCode: "Show more",
    showLessCode: "Show less",
    expandCode: "Expand code",
    closeExpandedCode: "Close expanded code",
